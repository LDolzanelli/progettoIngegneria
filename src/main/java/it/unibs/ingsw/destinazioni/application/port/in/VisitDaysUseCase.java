...
public interface VisitDaysUseCase {
    ...
    /**
     * Crea le visite di default per un mese specificato.
     * Le visite vengono create con status "PROPOSED".
     * 
     * @param month il mese per cui creare le visite (deve essere il mese corrente + 2)
     * @throws IllegalArgumentException se il mese non è valido o se non è possibile
     *                                 creare visite per il mese specificato
     */
    ...
    /**
     * Aggiorna i giorni di visita per un mese specificato.
     * 
     * @param month il mese per cui aggiornare le visite
     * @throws IllegalArgumentException se il mese non è valido
     */
    /*@ requires month >= 1 && month <= 12;
      @ ensures (\forall Visit v; v.getDate().getMonthValue() == month; 
      @          v.getVisitStatus() != null);
      @ signals (IllegalArgumentException e) month < 1 || month > 12;
      @*/
     ...
     * @throws IllegalArgumentException se il volontario non esiste o non ha ruolo VOLUNTEER
     */
    /*@ requires volunteerNickname != null && !volunteerNickname.trim().isEmpty();
      ...
      @ signals (IllegalArgumentException e) volunteerNickname == null || 
    ...
    /*@ requires visitId > 0;
      ...
      @ signals (IllegalArgumentException e) visitId <= 0 || 
