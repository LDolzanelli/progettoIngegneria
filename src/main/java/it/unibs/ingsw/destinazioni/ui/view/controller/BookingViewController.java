...
public class BookingViewController {
    ...
    public String bookVisitForm(@RequestParam int visitId,
        ...
        int userId = 0;
        try {
            String urlUser = apiBaseUrl + "/users/get-id/" + principal.getUsername();
        ...
        try {
            String urlVisit = apiBaseUrl + "/visit/details/" + visitId;
        ...
        int maxTickets = 1;
        try {
            String urlMax = apiBaseUrl + "/system-config/getMaxTickets";
        ...
        try {
            ...
            int maxParticipants = visit != null ? visit.maxParticipants() : 0;
            int currentParticipants = visit != null ? visit.numberOfParticipants() : 0;
            int maxTicketsBeforeFull = maxParticipants - currentParticipants;

            if (maxTickets > maxTicketsBeforeFull) {
                maxTickets = maxTicketsBeforeFull;
            }
            model.addAttribute("maxTickets", maxTickets);
        } catch (Exception e) {
            model.addAttribute("error", "Errore nel recupero della visita");
        }
    ...
    public String bookVisitSubmit(@RequestParam int visitId,
        ...
        try {
            ...
            try {
                ...
                redirectAttributes.addFlashAttribute("error", "Errore nel trovare la visita");
            }
            ...
            restTemplate.postForEntity(apiBaseUrl + "/booking/book", requestBody, Void.class);
